...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  let tripleSum = sum(a, b)[0];
  tripleSum = sum(tripleSum, c)[0];
  let tripleProduct = multiply(a,b)[0];
  tripleProduct = multiply(tripleProduct, c)[0]; // second element
  let sumString = `${a} and ${b} and ${c} sum to ${tripleSum}.`;
  let sumProduct = `The product of ${a} and ${b} and ${c} is ${tripleProduct}.`;
  
  return [tripleSum, tripleProduct, sumString, sumProduct];
}

// Here is the test for sumAndMultiply(); uncomment it to run it
testSumAndMultiply(4,7,5); // test pass!
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  let arrProductString = `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${arrayProduct}.`;
  return [arrayProduct, arrProductString];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  return [dynamicProduct, dynamicString];
}
